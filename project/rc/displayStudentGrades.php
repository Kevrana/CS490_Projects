...
// ------------------- 490_studentgrades All Grades for particular Student start ------------

$ucid   = $_POST ['ucid'] ;

$squery = "SELECT * FROM 490_studentgrades WHERE ucid='$ucid'";
...
// ------------------- 490_studentgrades All Grades for particular Student end ------------
