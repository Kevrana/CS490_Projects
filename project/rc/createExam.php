...
function createExam ($examid,$qid1,$qid2,$qid3, $eName, $q1val, $q2val, $q3val, $sql_cnct) 
{
	...
	if ( $question1=="" || $question1==":" || trim($question1)=="" || $question2=="" || $question2==":" || trim($question2)=="" || $question3=="" || $question3==":" || trim($question3)=="" )
{
	...
	$inE   = "INSERT INTO 490_exams VALUES ('$examid','$eName','$question1','$question2','$question3', '$q1val', '$q2val', '$q3val') ";
...
{
createExam ($examid, $qid1, $qid2, $qid3, $eName, $q1val, $q2val, $q3val, $sql_cnct);
}
