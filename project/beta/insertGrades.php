...
function insertGrades ($gid, $examid, $ucid, $g1, $g2, $g3, $comment, $sql_cnct) 
{
	$inG   = "INSERT INTO 490_grades VALUES ('$gid', '$examid', '$ucid', '$g1', '$g2', '$g3', '$comment' ) ";
...
{
insertGrades ($gid, $examid, $ucid, $g1, $g2, $g3, $comment, $sql_cnct);
}
